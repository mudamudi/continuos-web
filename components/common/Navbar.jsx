  ...
  return (
    <nav className="navbar navbar-expand-lg bord blur">
      <div className="container o-hidden">
        <a className="logo icon-img-100" href="/home-main">
          <img src="/assets/imgs/logo staempel1.png" alt="logo" />
        </a>
        ...
        >
          <ul className="navbar-nav">
            <li className="nav-item">
              <a className="nav-link" href="/home-personal">
                <span className="rolling-text">Profile</span>
              </a>
